...
int main()
{
  ...
  // Wireframe Enable
  //glPolygonModeG(L_FRONT, GL_LINE);
  ...
  //for some reason i have to give the entire file path, same with the assests
  Shader ShaderProgram(
		       std::vector<std::string>{"/home/baley/Projects/OpenGL/OpenGL2/Shaders/VertexShader.txt", "/home/baley/Projects/OpenGL/OpenGL2/Shaders/FragmentShader.txt"},
		       std::vector<GLenum>{GL_VERTEX_SHADER, GL_FRAGMENT_SHADER}
		       );
  /*
  std::ifstream File;
  File.open("/home/baley/Projects/OpenGL/OpenGL2/FragmentShader.txt");
  ...
  */
  ...
  Object Obj2("/home/baley/Projects/OpenGL/OpenGL2/assets/teapot.obj");
